...
import "@/app/profile/[id]/settings/profile-settings.css";
            ...
            <div className="profile-personal-info-section  p-6 rounded-lg  bg-white w-full h-[539px] mt-[140px] ">
                ...
                <div className="profile-personal-inputs mt-[40px]  gap-6">
                    <div className="w-full ">
                        <label className="text-[20px] leading-[23.44px] font-semibold  ">
                            Full Name
                        </label>
                        <input
                            type="text"
                    ...
                    <div>
                        <h1 className="text-[24px] font-semibold mt-6">
                        ...
                        <button className="bg-white text-black px-6 py-2 w-[243px] h-[52px] text-[20px] font-semibold leading-[28.13 px] rounded-[50px] border border-secondary hover:bg-greenbutton hover:text-white mt-6 justify-center">
                            {" "}
                            Change Password
                        </button>
                    </div>
