                ...
                >
                    <div className="hero-text-container flex justify-center">
                        <div className="hero-heading p-5 font-roboto font-bold text-[56px] leading-[72px] text-center mt-24 text-black h-36 w-full max-w-4xl">
                            <h1>
                                Be the Change You Wish to See Volunteer Today!
                            </h1>
                        </div>
                    </div>
                    <div className="hero-subheading p-0 font-roboto font-normal text-xl leading-7 text-center mt-10 text-gray-600">
                        <h2 className="first-h2">
                            Discover impactful events near you, connect with
                            your
                        </h2>
                        <h2 className="second-h2">
                            community, and make a difference where it matters
                            most.
                        </h2>
                    </div>
                </div>
            ...
            <section className="whatwedo-section w-full max-w-full h-[758px] mt-[108px]">
                <div className="whatwedo-header text-center mt-[10px] gap-[24px] font-roboto w-[1016px] h-[172px] align-center mx-auto">
                    ...
                    <p className="whatwedo-description text-gray-600 mt-4 font-[400] text-[24px] leading-[28.13px]">
                        We help you host impactful volunteer events and find
                        opportunities to contribute to meaningful causes in your
                        community.
                    </p>
                </div>
                    ...
                    <div className="whatwedo-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div className="whatwedo-card bg-green-100 p-8 rounded-[20px] text-center w-[288px] h-[276px]">
                            ...
                            <p className="whatwedo-card-description text-gray-600 text-[16px] font-[400] leading-[18.75px] w-[240px] mx-auto">
                                Whether you're passionate about the environment,
                                animal welfare, or social causes, our platform
                                makes it simple for you to create and host
                                volunteer events. Engage your community, raise
                        ...
                        <div className="whatwedo-card bg-green-100 p-8 rounded-[20px] text-center w-[288px] h-[276px]">
                            ...
                            <p className="whatwedo-card-description text-gray-600 text-[16px] font-[400] leading-[18.75px] w-[240px] mx-auto">
                                Looking for ways to give back? Browse local
                                volunteer opportunities and join events that
                                match your interests. Every action counts in
                        ...
                        <div className="whatwedo-card bg-green-100 p-8 rounded-[20px] text-center w-[288px] h-[276px]">
                            ...
                            <p className="whatwedo-card-description text-gray-600 text-[16px] font-[400] leading-[18.75px] w-[240px] mx-auto">
                                Volunteerism connects people. By hosting or
                                joining events, you meet like-minded individuals
                                who share your vision for a better world.
                            </p>
                        </div>
                        ...
                        <div className="whatwedo-card bg-green-100 p-8 rounded-[20px] text-center w-[288px] h-[276px]">
                            ...
                            <p className="whatwedo-card-description text-gray-600 text-[16px] font-[400] leading-[18.75px] w-[240px] mx-auto">
                                See the difference you’re making! Our platform
                                allows you to track the events you've hosted or
                                participated in and share your experiences with
                                others.
                            </p>
                        </div>
                    </div>
